...
const RegistroUsuario: React.FC<RegistroUsuarioProps> = ({ onRegisterSuccess, onUpdateSuccess, onClose, userToEdit, permissions }) => {
    ...
    return (
        <div className="p-4 bg-[var(--bg-card)] text-[var(--text-primary)] h-full overflow-y-auto">
            <style>{`
                .form-container-erp { max-width: 800px; margin: 0 auto; }
                .form-container-erp h2 { text-align: center; color: var(--text-primary); margin-bottom: 25px; }
