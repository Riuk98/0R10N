...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-[#fffefc] text-[var(--color-text)] py-10 px-6 sm:px-12 lg:px-24 flex justify-center">
            <div className="bg-[#f5f0e1] rounded-xl shadow-lg shadow-[var(--color-secondary)]/15 p-10 w-full max-w-7xl">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-start">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 mb-4">
                            <a href="#" className="text-[var(--color-secondary)] hover:opacity-80 transition-opacity">
